 ...
 * @author henri
 */
public class TelaMudarSenha extends javax.swing.JDialog {

    /**
     * Creates new form TelaRecuperacao
     */
    public TelaMudarSenha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaMudarSenha dialog = new TelaMudarSenha(new javax.swing.JFrame(), true);
